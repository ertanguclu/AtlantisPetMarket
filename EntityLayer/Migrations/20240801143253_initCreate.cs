    ...
    public partial class initCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 8, 1, 17, 32, 53, 184, DateTimeKind.Local).AddTicks(4207), "Kedi" },
                    { 2, new DateTime(2024, 8, 1, 17, 32, 53, 184, DateTimeKind.Local).AddTicks(4209), "Köpek" },
                    { 3, new DateTime(2024, 8, 1, 17, 32, 53, 184, DateTimeKind.Local).AddTicks(4211), "Kuş" },
                    { 4, new DateTime(2024, 8, 1, 17, 32, 53, 184, DateTimeKind.Local).AddTicks(4213), "Balık" },
                    { 5, new DateTime(2024, 8, 1, 17, 32, 53, 184, DateTimeKind.Local).AddTicks(4214), "Kemirgen" }
                });
